...
cp docs/notebooks/notebook_setup.py docs/_static/notebooks/notebook_setup.py

git add docs/_static/notebooks/notebook_setup.py
git add docs/_static/notebooks/*.ipynb
