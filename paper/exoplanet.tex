...
Instead, it efficiently evaluates the \emph{exact} derivative of a piece of code for some given inputs by implicitly applying the chain rule to each operation in the code.
