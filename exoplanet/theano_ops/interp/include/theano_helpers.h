...
inline Eigen::Map<Eigen::Matrix<T2, Eigen::Dynamic, 1>> get_points_grid (PyArrayObject* input) {
  Eigen::Map<Eigen::Matrix<T1, Eigen::Dynamic, 1>> points((T1*)PyArray_DATA(input), PyArray_SIZE(input));
